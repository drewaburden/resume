...
public class Music {
	...
	public Music() {
		Assets.getInstance().load("music/dialog-intro.ogg", com.badlogic.gdx.audio.Music.class);
		Assets.getInstance().load("music/dialog-loop.ogg", com.badlogic.gdx.audio.Music.class);
		Assets.getInstance().load("music/battle-intro.ogg", com.badlogic.gdx.audio.Music.class);
		Assets.getInstance().load("music/battle-loop.ogg", com.badlogic.gdx.audio.Music.class);
		Assets.getInstance().load("music/victory-intro.ogg", com.badlogic.gdx.audio.Music.class);
		Assets.getInstance().load("music/victory-loop.ogg", com.badlogic.gdx.audio.Music.class);
		Assets.getInstance().load("music/gameover.ogg", com.badlogic.gdx.audio.Music.class);
	}

	public void initAssets() {
		battle_intro = Assets.getInstance().get("music/battle-intro.ogg");
		battle_loop = Assets.getInstance().get("music/battle-loop.ogg");
		battle_intro.setVolume(VOLUME_MODIFIER);
		battle_loop.setVolume(VOLUME_MODIFIER);
		dialog_intro = Assets.getInstance().get("music/dialog-intro.ogg");
		dialog_loop = Assets.getInstance().get("music/dialog-loop.ogg");
		dialog_intro.setVolume(VOLUME_MODIFIER);
		dialog_loop.setVolume(VOLUME_MODIFIER);
		victory_intro = Assets.getInstance().get("music/victory-intro.ogg");
		victory_loop = Assets.getInstance().get("music/victory-loop.ogg");
		victory_intro.setVolume(VOLUME_MODIFIER*1.5f);
		victory_loop.setVolume(VOLUME_MODIFIER*1.5f);
		gameover = Assets.getInstance().get("music/gameover.ogg");
